package com.linkage.module.topo.framework.core.style.layout
{
	 ...
	 *
	 */
	public class RightCenterLayout implements ILayout
	{
		public function RightCenterLayout()
		{
		}
		...
		public function layoutPointLabel(text:String, label:IVisualElement, feature:Feature,fromPoint:Point,toPoint:Point):IVisualElement
		{
			...
			//			label.y = -2 - fontSize;
			label.x = fromPoint.x + (toPoint.x - fromPoint.x)/4;
			label.y = fromPoint.y + (toPoint.y - fromPoint.y)/4;
